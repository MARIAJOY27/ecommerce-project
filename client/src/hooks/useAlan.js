  ...
  useEffect(() => {
    ...
    setAlanInstance(
      alanBtn({
        ...
        // onCommand: (commdandData) => {
        //   console.warn(commdandData)
        //   window.dispatchEvent(new CustomEvent(commdandData.command, { detail: commdandData.payload }))
        //   if (commdandData.command === 'getUsername') {
        //     methods.setValue('username',commdandData.value);
        //   }
        //   if (commdandData.command === 'getPassword') {
        //     methods.setValue('password',commdandData.value);
        //   }
        // }
